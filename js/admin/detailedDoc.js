...
window.onload = function()
{
    ...
    function showall()
    {
        ...
        xmlhttp.open("get","detailedDoc?name=comment&admin=admin&id="+m('id').value,true);
	...
	m('send').onclick = function()
	{
		...
		var url = "detailedDoc?name=addComment&admin=admin&id="+m('id').value+"&score="+score+"&message="+message;
        //alert("url: "+url);
